...
2. 서비스 3개 생성:
   ...
   - **celery-worker**: 같은 이미지, 시작 명령 `celery -A app.celery_app worker --loglevel=info --concurrency=4 -Q celery,render` (렌더 속도↑; 렌더 전용 워커 분리·튜닝은 `docs/RAILWAY_DEPLOY.md` §1 참조)
